...
export default function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden pt-32 pb-20" style={{ backgroundColor: '#141414' }}>
      ...
      <div className="absolute inset-0 -z-10">
        <motion.div
          ...
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-br from-[#2BA3FF]/30 via-purple-900/20 to-[#2BA3FF]/30 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.1, 1, 1.1],
          ...
          className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-gradient-to-br from-blue-900/25 via-[#2BA3FF]/15 to-purple-900/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.15, 1],
          ...
          className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-gradient-to-br from-purple-900/20 via-[#2BA3FF]/10 to-blue-900/20 rounded-full blur-3xl"
        />
        ...
        >
          <motion.div
            ...
            className="text-[200px] md:text-[300px] font-bold text-white/5 select-none"
          >
            DeFi
          </motion.div>
        </motion.div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group px-8 py-4 bg-[#2BA3FF] text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden"
            >
              <motion.div
